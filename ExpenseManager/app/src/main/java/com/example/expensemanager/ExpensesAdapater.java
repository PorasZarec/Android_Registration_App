...
public class ExpensesAdapater extends RecyclerView.Adapter<ExpensesAdapater.MyViewHolder> {
    private Context context;
    private OnItemsClick onItemsClick;
    private List<ExpenseModel> expenseModelList;

    public ExpensesAdapater(Context context, OnItemsClick onItemsClick) {
